    ...
    <div class="flex--position-center-v mar--auto">
      ...
      <div id="hexcontainer">
        ...
        <div class="hex1 hoverable" :class="{ 'showHover' : isHistory }">
          <div class="hex2">
            <div id="testimonial" class="hexlink"
              @click="viewHistory()">
              <div class="hexcover"></div>
              <h3>History</h3>
              <div class="plus"></div>
      ...
      <div v-if="isHistory" class="description description--left">
        ...
        <div v-for="item in history" :key="item.company"
          ...
          <div v-for="(resp, index) in item.responsibilities" :key="index"
